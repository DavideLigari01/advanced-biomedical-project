...
\title{Heart Disease Prediction from heart beat audio signals using Machine Learning }
...
\input{./sections/correlation_analysis.tex}
...
\input{./sections/multiclass_model.tex}
\input{./sections/normal_vs_rest.tex}
\input{./sections/diseases_only.tex}

% ------------------- Best Model Analysis -------------------
\input{./sections/best_model_analysis.tex}
